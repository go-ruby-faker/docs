...
Contributions are welcome. `go-ruby-faker/faker` is built to a small set of
...
The library is in [`github.com/go-ruby-faker/faker`](https://github.com/go-ruby-faker/faker).
This documentation site is in [`github.com/go-ruby-faker/docs`](https://github.com/go-ruby-faker/docs).
